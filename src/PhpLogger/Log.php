 ...
 * Добавляем класс в проект, включая его через require_once
 * В файле класса в самом низу производим самоинициализацию
 * с помощью методов setup() или setupByConfig()
 *
 * @todo 3.x
 *
 * @todo 4.0
 * @todo Индекс ротируемых файлов делать перед расширением, а не после
